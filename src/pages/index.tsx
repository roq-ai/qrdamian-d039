...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`qrDamian`}</title>

        <meta
          name="description"
          content="Welcome to qrDamian - Your ultimate solution for backend QR image generation. Experience effortless, efficient, and secure QR code creation."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1595079676339-1534801ad6cf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxxciUyMGNvZGV8ZW58MHx8fHwxNjk2ODE2ODY2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to qrDamian - Your ultimate solution for backend QR image generation. Experience effortless, efficient, and secure QR code creation.`}
            </Text>
            <Box
