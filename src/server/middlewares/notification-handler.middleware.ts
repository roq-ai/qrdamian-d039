...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order.create': { roles: ['owner', 'administrator', 'developer'], key: 'order', tenantPath: [], userPath: [] },
  'Order.update': { roles: ['owner', 'administrator', 'developer'], key: 'order', tenantPath: [], userPath: [] },
  'Feedback.create': { roles: ['owner', 'administrator', 'developer'], key: 'feedback', tenantPath: [], userPath: [] },
};
